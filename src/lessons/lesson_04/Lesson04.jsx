  ...
  return (
    <div className="lesson-container">
      ...
      <p>
        ...
        результате вызова хука useState. если это переменная изменится - это
        будет сигнал к обновлению страницы
      </p>
      <p>
        Чтобы изменить значение состояния мы используем функцию, которая
        приходит вторым элементом в массиве из useState() - она перезаписывает
        состояние
      </p>
      <p>
        Изменение состояния вызывает ререндр компонента с новыми данными и как
        следствия код в теле функция компонента срабатывает заново
      </p>
    </div>
  );
}
